...
/* ─── Sidebar ────────────────────────────────────────── */
function Sidebar({ active, onSelect, collapsed, onToggle, user, onLogout }) {
  return (
    <motion.aside
      ...
      >
        ...
        <header className="sticky top-0 z-30 bg-white border-b border-slate-100 shadow-sm">
          <div className="flex items-center justify-between px-8 py-4">
            <div>
              <p className="text-[#001F54] font-bold text-lg">{activeNav?.label}</p>
              <p className="text-slate-400 text-xs">{SCHOOL_NAME} — Admin Portal</p>
            </div>
